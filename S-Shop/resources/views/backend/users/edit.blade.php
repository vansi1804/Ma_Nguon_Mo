   ...
   <div class="form-group">
      ...
      <div class="input-group">
         <span class="input-group-btn">
            <a id="lfm" data-input="thumbnail" data-preview="holder" class="btn btn-primary" disabled>
               <i class="fa fa-picture-o">
               </i> Choose
            </a>
         </span>
         <input id="thumbnail" class="form-control" disabled type="text" name="photo" value="{{$user->photo}}">
      </div>
