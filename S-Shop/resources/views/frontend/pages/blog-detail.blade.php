         ...
         <div class="col-12">
            <div class="bread-inner">
               <ul class="bread-list">
                  ...
                  <li class="active">
                     <a href="javascript:void(0);">Blog Single Sidebar</a>
                  </li>
               </ul>
            </div>
         </div>
               ...
               <div class="row">
                  <div class="col-12">
                     ...
                     <div class="blog-detail">
                        ...
                        <div class="blog-meta">
                           <span class="author">
                              <a href="javascript:void(0);">
                                 <i class="fa fa-user">
                                 </i>By {{$post->author_info['name']}}</a>
                              <a href="javascript:void(0);">
                                 <i class="fa fa-calendar">
                                 </i>{{$post->created_at->format('M d, Y')}}</a>
                              <a href="javascript:void(0);">
                                 <i class="fa fa-comments">
                                 </i>Comment ({{$post->allComments->count()}})</a>
                           </span>
                        </div>
                        ...
                        <div class="content">
                           @if($post->quote)
                           <blockquote> <i class="fa fa-quote-left">
                              </i> {!! ($post->quote) !!}</blockquote>
                           @endif
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-12">
                                    <div class="form-group  comment_form_body">
                                       ...
                                       <textarea name="comment" id="comment" rows="10" placeholder="">
</textarea>
                  ...
                  <div class="col-12">
                     <div class="comments">
                        ...
                        <!-- Single Comment -->
                        @include('frontend.pages.comment', ['comments' => $post->comments, 'post_id' => $post->id,
                        'depth' => 3])
                        <!-- End Single Comment -->
                     </div>
                  </div>
            ...
            <div class="main-sidebar">
               ...
               <div class="single-widget search">
                  <form class="form" method="GET" action="{{route('blog.search')}}">
                     ...
                     <button class="button" type="sumbit">
