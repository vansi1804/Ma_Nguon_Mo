            ...
            <div class="row">
               ...
               <div class="col-lg-6 col-12">
                  <div class="product-des">
                     ...
                     <!-- Color -->
                     {{-- <div class="color">
												<h4>Available Options <span>Color</span>
</h4>
												<ul>
													<li>
<a href="#" class="one">
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="col-lg-12 col-12">
                                                   <div class="form-group">
                                                      ...
                                                      <textarea name="review" rows="6" placeholder="">
</textarea>
                                                   </div>
                                                </div>
                                                <div class="col-lg-12 col-12">
                  ...
                  <div class="quickview-content">
                     ...
                     <div class="quickview-peragraph">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia iste laborum ad impedit
                           pariatur esse optio tempora sint ullam autem deleniti nam in quos qui nemo ipsum numquam.</p>
                     </div>
                     <div class="size">
                        <div class="row">
                           <div class="col-lg-6 col-12">
